...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("segformer_b0_backbone_weights.pth"), strict=False)
...
class SegFormer(nn.Module):
    def __init__(self, num_classes=21, phi='b0', pretrained=False, **kwargs):
...
if __name__ == '__main__':
    import torch
    # from model_tools.segformer import SegFormer

    model = SegFormer(num_classes=47, phi='b0', pretrained=True)
