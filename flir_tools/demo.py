...
# Iron 调色板
iron_colors = [(0, '#000000'), (0.15, '#410000'), (0.25, '#6d0000'), (0.35, '#930000'),
               (0.45, '#b70000'), (0.55, '#d90000'), (0.65, '#f40000'), (0.75, '#ff2a00'),
               (0.85, '#ff5100'), (0.95, '#ff7500'), (1, '#ff9900')]
...
print(len(iron_palette))
# iron_cmap = mcolors.LinearSegmentedColormap.from_list("iron", iron_colors)
#
# # 生成一些示例数据
...
#
# # 绘制图像
# plt.imshow(data, cmap=iron_cmap)
# plt.colorbar()
# plt.show()
