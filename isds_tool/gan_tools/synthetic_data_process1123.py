...
if __name__ == '__main__':
    data_name = 'synthetic_data_add1_v2'
    ...
    output_data_dir = r'\\158.132.186.40\isds\huilin\isds\check_data\synthetic_data_add1_v2'
    # result_merge(dst_obj_dir1, input_data_dir, output_data_dir)

    output_data_dir_b = r'\\158.132.186.40\isds\huilin\isds\check_data\synthetic_data_add1_v2_b'
    extract_single_risk_keep_single(os.path.join(output_data_dir, 'labels'), os.path.join(output_data_dir_b, 'labels'), 'b')
