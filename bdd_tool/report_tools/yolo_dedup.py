...
import subprocess
import time
from preprocess import FloorManager
...
# ===================== 2. 核心处理流程 =====================
def yolo_project2facade_adaptive(img_dir, yolo_txt_dir, floor_manager, target_classes=None):
    all_dets = []
    gid = 0
...
def yolo_dedup_pipeline(img_dir, yolo_txt_dir, output_dir, floor_heigth_path,
    ...
    floor_manager = FloorManager(cache_file=floor_heigth_path)

    # 1. 读取并筛选
    all_dets = yolo_project2facade_adaptive(img_dir, yolo_txt_dir, floor_manager, target_classes)
...
if __name__ == "__main__":
    ...
    floor_heigth_path = r'\\158.132.186.40\isds\huilin\bdd\collected_data\HMT_data\docs\build_heights.json'
    ...
    for view_name in views_list:
        ...
        yolo_dedup_pipeline(
            ...
            floor_heigth_path=floor_heigth_path,
        )